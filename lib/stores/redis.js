...
function Redis (opts) {
  ...
  if ((RedisClient && (opts.redisPub instanceof RedisClient)) || (opts.redisPub instanceof Cluster)) {
  ...
  if ((RedisClient && (opts.redisSub instanceof RedisClient)) || (opts.redisSub instanceof Cluster)) {
  ...
  if ((RedisClient && (opts.redisClient instanceof RedisClient)) || (opts.redisClient instanceof Cluster)) {
